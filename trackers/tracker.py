...
import numpy as np
sys.path.append('../')
from utils import get_bbox_wdth, get_center_of_bbox
...
class Tracker:
    ...
    def detects_frames(self, frames):
        batch_size = 20
        detections = []
    ...
    def get_object_tracks(self, frames, read_from_stub=False, stub_path=None):
        ...
        print("Generating new detections and tracks...")
        detections = self.detects_frames(frames)
    ...
    def draw_ellipse(self, frame, bbox, color, track_id=None):
        ...
        if track_id is not None:
            ...
            cv2.rectangle(frame,(int(x1_rect), int(y1_react)),(int(x2_react), int(y2_react)), color,cv2.FILLED )
